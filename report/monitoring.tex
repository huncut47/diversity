...
Choosing the EFK stack over Grafana + Loki was, in our opinion, the wrong call for a project this small. Loki would have kept everything under one Grafana frontend. The choice was still worthwhile as a learning exercise. We engaged with the industry-standard logging stack and encounter the kinds of real-world problems that come with it. It also cleanly separated concerns: Grafana shows whether something is wrong, Kibana explains what happened.