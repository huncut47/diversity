...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{R9}: Attacker can abuse the exposed internal services host ports in \texttt{docker-compose.yml}.
    \item \textbf{R10}: Attacker brute-forces our short passwords in seconds.
\end{itemize}
...
We prioritized R2 and R9 because while they were critical, they were also relatively straightforward to fix. R10 was tackled since it was also a simple fix that was long overdue.
